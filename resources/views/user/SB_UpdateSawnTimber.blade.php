      ...
      <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        <div class="container">
          ...
          <div class="d-flex justify-content-between p-2 bg-light" style="height:85px;">
            ...
            <div class="p-4">
              <h4 class="text-black-50">Update Sawn Timber : </h4>
            </div>
            <div class="btn btn-group-sm">
              <a href="StockBookUpdate" class="btn btn-outline-success" data-bs-toggle="tooltip"
                title="Go Back!">&#129136;</a>
              <a href="SB_SawnTimber" class="btn btn-outline-success" data-bs-toggle="tooltip"
              ...
              <div class="mb-3 mt-3">
                ...
                <div class="row">
                  <div class="col bg-light" style="border:2px solid white; border-radius:12px; padding:5px;">
                    ...
                    <div class="col">
                      <input type="text" class="form-control" id="sourceoflogs" placeholder="" name="sourceoflogs"
                        required>
                    </div>
                  </div>
                </div>
