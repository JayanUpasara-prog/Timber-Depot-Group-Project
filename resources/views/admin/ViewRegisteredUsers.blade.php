...
<div class="container-fluid">
  <div class="row">
      ...
      <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        <div class="container">
          <div class="p mb-2 bg-success text-white text-center"> <h2>View Registered Users</h2>
      </div>
    ...
    <tr>
        ...
        <tr>
            ...
            <td><a href="/ViewRecords/{{$ViewRegisteredRecords->id}}"><button class ="btn btn-primary">view</button></a></td>
        </tr>
        @endforeach 
