...
<html lang="en">
<head>
  <title>View Permit Requests</title>
  <meta charset="utf-8">
...
<div class="container-fluid">
  <div class="row">
      ...
      <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        <div class="container">
          <div class="p mb-2 bg-success text-white text-center"> <h2>View Permit Requests</h2>
      </div>
    ...
    <tr>
        ...
        @foreach($viewPermit as $viewPermit)
        <tr>
          <td>{{ $viewPermit->id }}</td>
            <td>{{ $viewPermit->national_id_number }}</td>
            <td>{{ $viewPermit->email }}</td>
            <!-- <td><button class ="btn btn-primary">view</button></td> -->
            <td><a href="/ViewPermitRecords/{{$viewPermit->id}}"><button class ="btn btn-primary">view</button></a></td>
        </tr>
        @endforeach 
